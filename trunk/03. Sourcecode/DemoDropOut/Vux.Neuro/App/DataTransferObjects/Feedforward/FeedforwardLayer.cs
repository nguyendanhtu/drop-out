...
using System.Linq;
using System.Text;
using Vux.Neuro.App.DataTransferObjects.ActivationFunc;
using Vux.Neuro.App.DataTransferObjects.Exception;
using Vux.Neuro.App.DataTransferObjects.Matrix;

namespace Vux.Neuro.App.DataTransferObjects.Feedforward
{
    [Serializable]
    public class FeedforwardLayer
    {
        ...
        /// </summary>
        public IActivationFunction LayerActivationFunction
        {
            get
            {
